...
"""
\"\"\"
このpythonプログラムはScratchToPythonにより生成されました。
ScrathToPythonのライセンスはCC BY-NC-SA 4.0です。(https://creativecommons.org/licenses/by-nc-sa/4.0/deed.ja)

This python program was generated by ScracthToPython.
ScrathToPython's lisence is "CC BY-NC-SA 4.0".(https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en)
\"\"\"\n\n\n
"""
)
#import
